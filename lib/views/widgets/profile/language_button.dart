    ...
    return Container(
      ...
      child: CupertinoButton(
        ...
        child: Row(
          ...
          children: [
            Icon(icon, color: isSelected ? AppColors.backgroundSecondary : AppColors.iconColor, size: 20),
            const SizedBox(width: 10),
            Text(
              title,
              style: TextStyle(
                color: isSelected ? AppColors.backgroundSecondary : AppColors.iconColor,
